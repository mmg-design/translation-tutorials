...
export const tutorials: Tutorial[] = [
  {
    ...
    description:
      "A complete orientation to your new workspace — from first login to finding your first project brief. Paste your SOP here once you have your video recorded.",
    videoEmbed: null,
  },
  {
    id: "tutorial-2",
